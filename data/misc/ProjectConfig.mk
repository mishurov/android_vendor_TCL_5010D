...
#liuyang.wt for pixi4-5 imgsensor configuration
CUSTOM_HAL_IMGSENSOR = s5k5e8yx_front_mipi_raw_pixi4_5 s5k5e8yx_back_af_mipi_raw_pixi4_5 s5k5e8yx_back_ff_mipi_raw_pixi4_5 sp2508_front_mipi_raw_pixi4_5 c2590_front_mipi_raw_pixi4_5 gc5005_back_af_mipi_raw_pixi4_5 gc5005_back_ff_mipi_raw_pixi4_5 gc5005_front_mipi_raw_pixi4_5
#Start liuyang.wt MODIFY 20151220  modify for pixi4_5 LENS
#CUSTOM_HAL_LENS = ad5820af dw9714af dummy_lens
CUSTOM_HAL_LENS = dw9714af_pixi4_5 bu64240af_pixi4_5 gt9760saf_pixi4_5
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
#CUSTOM_HAL_MAIN_BACKUP_LENS = dw9714af
CUSTOM_HAL_MAIN_BACKUP_LENS = 
CUSTOM_HAL_MAIN_IMGSENSOR = s5k5e8yx_back_af_mipi_raw_pixi4_5 s5k5e8yx_back_ff_mipi_raw_pixi4_5 gc5005_back_af_mipi_raw_pixi4_5 gc5005_back_ff_mipi_raw_pixi4_5
#CUSTOM_HAL_MAIN_LENS = dw9714af
CUSTOM_HAL_MAIN_LENS = dw9714af_pixi4_5 bu64240af_pixi4_5 gt9760saf_pixi4_5
#End
...
#Begin ersen.shang 20151029 remove unused compile options
#CUSTOM_HAL_SUB_BACKUP_LENS = ad5820af
CUSTOM_HAL_SUB_BACKUP_LENS = 
#End   ersen.shang 20151029 remove unused compile options
#liuyang.wt for pixi4-5 imgsensor configuration
CUSTOM_HAL_SUB_IMGSENSOR = s5k5e8yx_front_mipi_raw_pixi4_5 sp2508_front_mipi_raw_pixi4_5 c2590_front_mipi_raw_pixi4_5 gc5005_front_mipi_raw_pixi4_5
...
#Start liuyang.wt,20151229,remove unused compile options
CUSTOM_KERNEL_GYROSCOPE =
#End liuyang.wt,20151229,remove unused compile options

CUSTOM_KERNEL_HDMI =
CUSTOM_KERNEL_HEADSET = accdet
#liuyang.wt for pixi4-5 imgsensor configuration
CUSTOM_KERNEL_IMGSENSOR = s5k5e8yx_front_mipi_raw_pixi4_5 s5k5e8yx_back_af_mipi_raw_pixi4_5 s5k5e8yx_back_ff_mipi_raw_pixi4_5 sp2508_front_mipi_raw_pixi4_5 c2590_front_mipi_raw_pixi4_5 gc5005_back_af_mipi_raw_pixi4_5 gc5005_back_ff_mipi_raw_pixi4_5 gc5005_front_mipi_raw_pixi4_5
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx

#Start liuyang.wt MODIFY 20151220 modify for pixi4_5 LENS
#CUSTOM_KERNEL_LENS = ad5820af dw9714af dummy_lens
CUSTOM_KERNEL_LENS = dw9714af_pixi4_5 bu64240af_pixi4_5 gt9760saf_pixi4_5
#End
...
#End   ersen.shang 20151029 remove unused compile options
#liuyang.wt for pixi4-5 imgsensor configuration
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k5e8yx_back_af_mipi_raw_pixi4_5 s5k5e8yx_back_ff_mipi_raw_pixi4_5 gc5005_back_af_mipi_raw_pixi4_5 gc5005_back_ff_mipi_raw_pixi4_5

#Start liuyang.wt MODIFY 20151220 modify for pixi4_5 LENS
CUSTOM_KERNEL_MAIN_LENS = dw9714af_pixi4_5 bu64240af_pixi4_5 gt9760saf_pixi4_5
#End
...
#End   ersen.shang 20151029 remove unused compile options
#liuyang.wt for pixi4-5 imgsensor configuration
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k5e8yx_front_mipi_raw_pixi4_5 sp2508_front_mipi_raw_pixi4_5 c2590_front_mipi_raw_pixi4_5 gc5005_front_mipi_raw_pixi4_5
...
CUSTOM_MODEM = jhz6580_we_m_hspa jhz6580_we_m_gprs
...
#removed by wanlin.qin 20151023 for T710102
...
#BEGIN: fangjie modify for Arkamys audio solution for defect779734 20151104
#MTK_BESLOUDNESS_SUPPORT = yes
MTK_BESLOUDNESS_SUPPORT = no
#END: fangjie modify for Arkamys audio solution for defect779734 20151104
...
MTK_BUILD_VERNO = alps-mp-m0.mp1-V2.34_jhz6580.we.m_P43
MTK_BWC_SUPPORT = yes
MTK_C2K_SUPPORT = no
...
MTK_CMAS_SUPPORT = yes #Defect 392031 Customize CMAS by weiwen.huang.hz
...
#begin 20151116 modify by wwanying for task730344 from yes to no
MTK_CTA_SET = no
#end 20151116 modify by wwanying for task730344 from yes to no
MTK_CTA_SUPPORT = no
...
##close it by xiaorong.ling for task839949
...
MTK_DT_SUPPORT = no
#Start liuyang.wt,20151222,modify for Dual MIC
...
#modify by fangyan for OTP, old:no task742725,742727
...
#begin 20151110 modify yes to no by lixiang.he for task 857514
MTK_FILEMANAGER_APP = no
#end 20151110 modify yes to no by lixiang.he for task 857514
MTK_FIRST_MD = 1
...
# modify by chaotu.liao for task800036 remove hotknot begin 
MTK_HOTKNOT_SUPPORT = no
# modify by chaotu.liao for task800036 remove hotknot end
...
MTK_ION_SUPPORT = yes
#chenjiexin set MTK_IPOH_SUPPORT to no for task :1407560,20160114
MTK_IPOH_SUPPORT = no
MTK_IPO_MDRST_SUPPORT = no
#chenjiexin set MTK_IPO_SUPPORT to no for task :1407560,20160114
MTK_IPO_SUPPORT = no
MTK_IPTV_SUPPORT = no
...
MTK_ISMS_SUPPORT = no
MTK_JAZZ = no
#jiangjingjing modify for charge-20151109-begin-defect 811778
MTK_JEITA_STANDARD_SUPPORT = no
#jiangjingjing modify for charge-20151109-end-defect 811778
MTK_K64_SUPPORT = no
...
#begin heqiang modify for task1990097 20160424
#MTK_MIRAVISION_SETTING_SUPPORT = yes
#begin heqiang modify for task2013399 20160503
#MTK_MIRAVISION_SETTING_SUPPORT = no
MTK_MIRAVISION_SETTING_SUPPORT = yes
#end heqiang modify for task2013399 20160503
#end heqiang modify for task1990097 20160424
#begin heqiang add for task1990097 20160424
PHOTOTABLE_SUPPORT = no
#begin heqiang modify for task2012427 20160429
#HTMLVIEWER_SUPPORT = no
HTMLVIEWER_SUPPORT = yes
#end heqiang modify for task2012427 20160429
#end heqiang add for task1990097 20160424
MTK_MLC_NAND_SUPPORT = no
MTK_MMPROFILE_SUPPORT = yes
MTK_MMUMAP_SUPPORT = no
#close by yan.fang for D1998932 2016.5.11
...
# modify by chaotu.liao for task800036 remove MultiCoreObserver begin 
MTK_MULTICORE_OBSERVER_APP = no
# modify by chaotu.liao for task800036 remove MultiCoreObserver end 
...
#begin change yes to no by lixiang.he for task 980437 on 20151125
MTK_SEC_SECRO_AC_SUPPORT = no
#end change yes to no by lixiang.he for task 980437 on 20151125
...
MTK_SWIP_WMAPRO = no
#modify by fangyan to remove mtk system uptate for fota 20151120
...
MTK_VOICE_UI_SUPPORT = no #zyurong modify yes to no for defect1030741 20151208
#begin lkaishu modify yes to no for voice unlock
MTK_VOICE_UNLOCK_SUPPORT = no
#end lkaishu modify yes to no for voice unlock
...
MTK_WML_SUPPORT = yes
#begin zyurong modify yes to no for defect1541448 20160307
MTK_WMV_PLAYBACK_SUPPORT = no
#end zyurong modify yes to no for defect1541448 20160307
MTK_WORLD_PHONE = no
...
SIM_ME_LOCK_MODE = 0
#begin-20151123-jianping.zhang-modify-to-close sim refresh reset mode by modem
#SIM_REFRESH_RESET_BY_MODEM = yes
SIM_REFRESH_RESET_BY_MODEM = no
#end-20151123-jianping.zhang-modify-to-close sim refresh reset mode by modem
TELEPHONY_DFOSET = no
...
#BEGIN: fangjie add for Arkamys audio solution for defect779734 20151104
HAVE_ARKAMYS_AUDIOEFFECT_FEATURE = yes
#END: fangjie add for Arkamys audio solution for defect779734 20151104
#BEGIN:remove for new requirement of low RAM by yingying.qiao.hz 20151117
#LOW_RAM_GMS=yes
#END:remove for new requirement of low RAM by yingying.qiao.hz 20151117
#CREATE_PROJECT_INFO=2016021921349

#begin hgl remove Local Notes
TCT_LOCAL_NOTE = no
#end hgl remove Local Notes

#begin zhangyong add for mtk sound recorder 20160101
MTK_SOUNDRECORDER_APP = no
#end zhangyong add for mtk sound recorder 20160101

#BEGIN: liuyag.wt,ADD,201231,add for pixi4_5 audio 
#AWINIC_PA_SUPPORT = yes
LENS_DW9714AF_PIXI4_5 = yes
LENS_BU64240AF_PIXI4_5 = yes
LENS_GT9760SAF_PIXI4_5 = yes
FLASHLIGHT_PIXI4_5 = yes
CAMERA_3A_PIXI4_5 = yes
#END

# add begin 20160516 by xiaorong.ling for Defect2144746,add language list for recovery
TARGET_RECOVERY_UTF8_MULTILINGUAL = yes
# add end 20160516 by xiaorong.ling for Defect2144746,add language list for recovery
